    ...
    <Modal-Resource v-on:clear="clear" title="Registro de roles">
      ...
      <section slot="body">
        <form method="POST" @submit.prevent="add(form.id,action)" autocomplete="off">
          <form-wizard shape="tab" title subtitle color="#0982BB">
            <tab-content title="Información" icon="fi fi-persons">
              <div class="row">
                <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    ...
                    <div
                      v-if="
                                            ...
                                            "
                      class="invalid-feedback"
                    >{{ errors.first("nombre del negocio") }}</div>
                  </div>
                </div>
              </div>
            </tab-content>
            ...
            <button type="button" class="btn btn-outline-primary" slot="prev">
              <i class="fi fi-angle-dobule-left"></i>
            </button>
            <button type="button" class="btn btn-outline-primary" slot="next">
              <i class="fi fi-angle-dobule-right"></i>
            </button>
            <button
              type="submit"
              :hidden="errors.any()"
...
export default {
  ...
  methods: {
    ...
    clear() {
      ...
      this.form.type_person = null;
      this.form.regimen_type = null;
      this.form.responsible_iva = null;
